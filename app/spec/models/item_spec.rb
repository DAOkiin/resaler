...
RSpec.describe Item, type: :model do
  ...
  context 'enum' do
    it 'is real enum' do
      foo = described_class.create(search_id: search.id, source: :youla)
      bar = described_class.create(search_id: search.id, source: :avito)
      baz = described_class.create(search_id: search.id, source: :foobar)
